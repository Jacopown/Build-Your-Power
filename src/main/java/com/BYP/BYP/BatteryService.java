...
public class BatteryService {
	...
	public void performRandomActionsWithDelay(Battery battery, int maxIterations, long delay, List<User> users,
			List<Station> stations) { // delay is a value expressed in milliseconds
		...
		switch (randomAction) {
			...
			case 3:
				...
				if (battery.getUser() != null) {
					...
					emailService.sendEmail("aligiassioma72@gmail.com", battery.getId() + " is unreachable",
							"The battery is unreachable");
				}
				break;
		}
